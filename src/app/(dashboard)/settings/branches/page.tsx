...
export default withTenantContext(async function BranchesSettingsPage() {
  ...
  return (
    <div>
      ...
      <SettingsNav />
      <h2 className="mb-2 text-sm font-semibold">الفروع</h2>
      <SimpleEntityForm endpoint="/api/branches" placeholder="اسم الفرع" />
      <EditableEntityList items={branches} endpoint="/api/branches" />
    </div>
  );
});
